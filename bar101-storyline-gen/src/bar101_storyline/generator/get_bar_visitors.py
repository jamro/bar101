...
def get_bar_visitors(cusomer_picker, key_customer_id, prev_key_customer_id, variants_chain):
    ...
    if os.path.exists(visitors_path):
        ...
        visitors = cusomer_picker.get_random_patrons([key_customer_id, prev_key_customer_id])
